...
public class DroneService implements IDroneService {
	...
	// Calculate collision between two points using the euclidean distance
	private boolean isCollision(Coord coord1, Coord coord2) {
		int threshold = 5;

		double d = Math.pow(Math.pow(coord2.getX() - coord1.getX(), 2) + Math.pow(coord2.getY() - coord1.getY(), 2)
